...
const BusinessInformation: React.FC = (): React.ReactElement => {
  ...
  const { currentEnv } = useSelector((state) => state.white);
  ...
  const autoGeneratePersonalizedUrlHandler = (subdomain: string) => {
    const personalizedUrl = `https://${subdomain}.${currentEnv?.personalizedBaseUrl}`;
        ...
        <IonList>
          ...
          >
            ...
            <IonInput
              ...
              type="text"
              placeholder={t(
                "profile_settings_enter_page_name_above_to_generate"
              )}
          ...
          >
            ...
            <IonInput
              ...
              onIonInput={(e) =>
                formik.setFieldValue("legalName", e.detail.value)
              }
            />
          </IonItem>
          <IonItem
          ...
          >
            ...
            <IonSelect
              ...
              onIonChange={(e) =>
                formik.setFieldValue("country", e.detail.value)
              }
            >
          ...
          >
            <IonLabel position="stacked" class="custom-input">
              {t("profile_settings_address_line_1")}*
            </IonLabel>
            <IonInput
              class="custom"
              type="text"
              ...
              onIonInput={(e) =>
                formik.setFieldValue("addressLineOne", e.detail.value)
              }
            />
          </IonItem>
          <IonItem
          ...
          >
            <IonLabel position="stacked" class="custom-input">
              {t("profile_settings_address_line_2")}
            </IonLabel>
            <IonInput
              class="custom"
              type="text"
              ...
              onIonInput={(e) =>
                formik.setFieldValue("addressLineTwo", e.detail.value)
              }
            />
          </IonItem>
          <IonItem
          ...
          >
            ...
            <IonInput
              ...
              onIonInput={(e) =>
                formik.setFieldValue("zipCode", e.detail.value)
              }
            />
          </IonItem>
          <IonButton
