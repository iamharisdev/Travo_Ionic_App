...
const ReviewDetails: React.FC<ReviewDetailsProps> = ({
    ...
    try {
      ...
      if (
        ...
        const payload = {
          ...
          appoitmentId: selectedService?.id,
          payload:
  ...
  return (
    <div className={CSSPrefix}>
      ...
      <div className="custom-input-container" onClick={() => goToStep && goToStep(0)}>
      ...
      <div className="custom-input-container" onClick={() => goToStep && goToStep(1)}>
      ...
      <div className="custom-input-container" onClick={() => goToStep && goToStep(2)}>
      ...
      <div className="custom-radio-container" onClick={handleClick}>
        <IonIcon icon={isChecked ? radioButtonOn : radioButtonOff} className="custom-radio-icon" />
